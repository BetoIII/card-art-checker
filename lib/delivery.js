...
// ── Rocketlane space document upload ────────────────────────────────
...
// ── Public entrypoint ───────────────────────────────────────────────
//
// deliverReport posts the report to Slack + Rocketlane. Each service is
// independent: a Slack failure does not block Rocketlane upload.
// Returns { slack, rocketlane } with 'ok' | 'skipped' | 'failed: ...'.
