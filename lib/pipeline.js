...
export function buildVisualPrompt(techJson, cardType = 'virtual', hasBack = false, cropPaths = []) {
...
export async function runAnalysis({ file, fileName, backFile, backFileName, cardType, onProgress, deadlineAt }) {
  ...
  return { pdfBuffer, status, summary, results, techJson, cardType: resolvedCardType };
}
